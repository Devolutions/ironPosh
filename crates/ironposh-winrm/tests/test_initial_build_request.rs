...
mod tests {
    ...
    fn test_build_soap_envelope_for_shell_creation() {
        ...
        let shell_tag = Tag::new(shell)
            ...
            .with_attribute(ironposh_winrm::cores::Attribute::Name("Runspace1".into()));
        ...
        let envelope = envelope
            ...
            .with_declaration(ironposh_winrm::cores::namespace::Namespace::MsWsmanSchema)
            .with_declaration(ironposh_winrm::cores::namespace::Namespace::WsTransfer2004)
            .with_declaration(ironposh_winrm::cores::namespace::Namespace::WsmanShell)
            .with_declaration(ironposh_winrm::cores::namespace::Namespace::DmtfWsmanSchema)
            .with_declaration(ironposh_winrm::cores::namespace::Namespace::PowerShellRemoting);

        // Convert Tag to Element
        let element = envelope.into_element();

        // Create XML builder and convert to string
        let xml_builder = ironposh_xml::builder::Builder::new(None, element);
