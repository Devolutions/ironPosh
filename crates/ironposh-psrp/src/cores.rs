...
impl TryFrom<u32> for MessageType {
    ...
    fn try_from(value: u32) -> Result<Self, Self::Error> {
        match value {
            0x00010002 => Ok(Self::SessionCapability),
            0x00010004 => Ok(Self::InitRunspacepool),
            0x00010005 => Ok(Self::PublicKey),
            0x00010006 => Ok(Self::EncryptedSessionKey),
            0x00010007 => Ok(Self::PublicKeyRequest),
            0x00010008 => Ok(Self::ConnectRunspacepool),
            0x0002100B => Ok(Self::RunspacepoolInitData),
            0x0002100C => Ok(Self::ResetRunspaceState),
            0x00021002 => Ok(Self::SetMaxRunspaces),
            0x00021003 => Ok(Self::SetMinRunspaces),
            0x00021004 => Ok(Self::RunspaceAvailability),
            0x00021005 => Ok(Self::RunspacepoolState),
            0x00021006 => Ok(Self::CreatePipeline),
            0x00021007 => Ok(Self::GetAvailableRunspaces),
            0x00021008 => Ok(Self::UserEvent),
            0x00021009 => Ok(Self::ApplicationPrivateData),
            0x0002100A => Ok(Self::GetCommandMetadata),
            0x00021100 => Ok(Self::RunspacepoolHostCall),
            0x00021101 => Ok(Self::RunspacepoolHostResponse),
            0x00041002 => Ok(Self::PipelineInput),
            0x00041003 => Ok(Self::EndOfPipelineInput),
            0x00041004 => Ok(Self::PipelineOutput),
            0x00041005 => Ok(Self::ErrorRecord),
            0x00041006 => Ok(Self::PipelineState),
            0x00041007 => Ok(Self::DebugRecord),
            0x00041008 => Ok(Self::VerboseRecord),
            0x00041009 => Ok(Self::WarningRecord),
            0x00041010 => Ok(Self::ProgressRecord),
            0x00041011 => Ok(Self::InformationRecord),
            0x00041100 => Ok(Self::PipelineHostCall),
            0x00041101 => Ok(Self::PipelineHostResponse),
            _ => Err(crate::PowerShellRemotingError::InvalidMessage(format!(
