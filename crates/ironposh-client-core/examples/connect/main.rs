...
async fn run_event_loop(
    ...
    mut network_response_rx: mpsc::Receiver<
        ironposh_client_core::connector::http::HttpResponse<String>,
    >,
    mut user_request_rx: mpsc::Receiver<ironposh_client_core::connector::UserOperation>,
    network_request_tx: mpsc::Sender<ironposh_client_core::connector::http::HttpRequest<String>>,
    mut pipeline_tx: Option<oneshot::Sender<ironposh_client_core::powershell::PipelineHandle>>,
) -> anyhow::Result<()> {
    loop {
