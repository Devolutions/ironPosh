...
pub fn main() {
    ...
    let shell_tag = Tag::new(shell)
        .with_name(Shell)
        .with_attribute(protocol::cores::Attribute::ShellId("2D6534D0-6B12-40E3-B773-CBA26459CFA8".into()))
    ...
    let reply_to_address = Tag::new(AddressValue {
        url: Tag::new(Text::from("http://schemas.xmlsoap.org/ws/2004/08/addressing/role/anonymous"))
            .with_name(Address)
    ...
    let envelope = SoapEnvelope::builder()
        .header(
            SoapHeaders::builder()
                ...
                .action(
                    Tag::new(Text::from("http://schemas.xmlsoap.org/ws/2004/09/transfer/Create"))
                        .with_name(Action)
                        .with_attribute(protocol::cores::Attribute::MustUnderstand(true))
                )
                ...
                .resource_uri(
                    Tag::new(Text::from("http://schemas.microsoft.com/powershell/Microsoft.PowerShell"))
