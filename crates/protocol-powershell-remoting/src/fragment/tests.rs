    ...
    fn test_defragmenter_fragmented_message() {
        ...
        for (i, fragment) in fragments.iter().enumerate() {
            ...
            if i < fragments.len() - 1 {
                ...
                match result {
                    DefragmentResult::Incomplete => {},
                    DefragmentResult::Complete(_) => panic!("Unexpected complete result at fragment {}", i),
                }
                assert_eq!(defragmenter.pending_count(), 1);
            } else {
                ...
                match result {
                    ...
                    DefragmentResult::Incomplete => panic!("Expected complete message at last fragment"),
                }
                assert_eq!(defragmenter.pending_count(), 0);
            }
        }
